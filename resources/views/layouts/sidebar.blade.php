 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2" style="font-size: 16px;">{{ config('app.name', 'Finances-Tracker') }}</span>
            </a>
          ...
          <ul class="menu-inner py-1">
           ...
           <li class="menu-item">
              ...
              <a href="" class="menu-link">
                <i class="menu-icon fa-duotone fa-solid fa-wallet"></i>
          ...
          <li class="menu-item">
              ...
              <div class="text-truncate" data-i18n="Income">Expenses</div>
              </a>
            </li>
            ...
            <!-- categories-->
             ...
             <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
               <i class="menu-icon fa-sharp fa-solid fa-layer-group"></i>
